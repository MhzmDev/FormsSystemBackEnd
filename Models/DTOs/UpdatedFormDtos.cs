namespace DynamicForm.Models.DTOs
{
    ...
    public class PagedResultSubmission<T>
    {
        ...
        public int TodayApprovedSubmissionsCount { get; set; } // NEW: Count of approved submissions today
        public int TodayRejectedSubmissionsCount { get; set; } // NEW: Count of rejected submissions today
